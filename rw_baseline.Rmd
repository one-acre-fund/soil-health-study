...
```{r}
intensityVars <- c("field_kg_fert1_15b", "field_kg_fert2_15b",
                   "field_kg_compost_15b", "kg_lime_15b")
...
coefTableES2 <- coefTable[c(6,7,9,8,11),]
...
```{r, results='asis'}
modNames <- c("Calcium", "Magnesium", "pH", "Nitrogen", "Carbon", "Seasons fertilizer", "Seasons compost", "Seasons legumes", "Seasons fallow", "Fertilizer (log)")
