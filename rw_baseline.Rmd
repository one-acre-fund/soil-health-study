...
out.list <- c("female", "age", "hhsize", "own", "field.size",
              ...
              "slope",  "alt", "valley", "hillside", "hilltop")
...
table6vars <- paste(c("cows", "pigs", "sheep", "goats", "chickens"), collapse = "|")
