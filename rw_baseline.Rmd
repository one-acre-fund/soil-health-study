...
```{r}
ggplot(d, aes(x = compost.are, y=Total.C)) + geom_point() + 
  scale_x_continuous(limits=c(0,50)) + # remove larger values from the graph.
  geom_smooth(method='lm')
```

There are too many zero or near zero values. We can conclude that perhaps we're not asking this question well.
