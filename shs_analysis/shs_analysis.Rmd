...
> Look at rotations relative to N rate by 1AF status.
...
## Nitrogen by legume rotation by 1AF status
```{r}
...
intercrop_check %>%
  ...
  ggplot(., aes(x = as.factor(legume_count), y = total.nitrogen.average)) +
  geom_boxplot()
