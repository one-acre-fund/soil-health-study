...
```{r}
soilDir <- normalizePath(file.path("..", "..", "..", "mike.barber@oneacrefund.org", "One Acre Fund",  "OAF Soil Lab Folder", "Projects", "ke_shs_17", "4_predicted", "other_summaries"))
soil <- read.csv(file=paste(soilDir, "combined-predictions-including-bad-ones.csv", sep = "/"))

idDir <- normalizePath(file.path("..", "..", "..", "mike.barber@oneacrefund.org", "One Acre Fund",  "OAF Soil Lab Folder", "Projects", "ke_shs_17", "5_merged"))
