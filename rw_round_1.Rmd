...
I'm going to take a quick guess at how kg/m2 and t/ha yield calculations were made so that I can set up the analyses I want. 
**Disclaimer**: These should be updated based on what Nathaniel says.
...
py <- calculateYield("box_kg1", "box_kg2", "d_box_lenght1", "d_box_length2", "d_box_width1", "d_box_width2", py)
...
for(i in 1:length(soilVars)){
  print(
    respCurve(yr, "yield", soilVars[i],"Yield (kg/m2)", soilVars[i], gTitle = paste0("Basic response curve: ", soilVars[i]))
  )
}
