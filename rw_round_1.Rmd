...
libs <- c("dplyr", "reshape2", "knitr", "ggplot2", "tibble", "readxl", 
    "MASS", "gridExtra", "cowplot", "robustbase", "car", "RStata")
...
This function will remove all strange outputs from the data from CommCare
...
Convert variables that are supposed to be numbers to numbers in `r`
